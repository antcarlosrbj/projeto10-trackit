...
export default function HabitsList({token, renderAgain, setRenderAgain}) {
                    ...
                    habits.map((element, index) => {
                        return (
                            <div className="habit" key={index}>
                                <svg onClick={() => deleteHabit(element.id)} width="13" height="15" viewBox="0 0 13 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="days">
                                    {
                                        daysOfTheWeek.map((day, index) => {
                                            if(element.days.findIndex((value) => value == index) != -1) {
                                                return <div className="day selected">{day}</div>
                                            } else {
...
const HabitsListDiv = styled.div`
    padding: 0 18px;
    font-size: 18px;
    color: #666666;
